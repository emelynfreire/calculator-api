Esse projeto tem como intuito a criação de uma calculadora simples utilizando o Framework Django, a calculadora funciona atravez do sistema de rotas e urls, no qual retorna funções criadas nas views.
